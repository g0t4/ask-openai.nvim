...
_describe("GetPos wrappers", function()
    ...
    _describe("GetPosPosition", function()
        ...
        describe("in_range(ts_node: TSNode)", function()
            ...
            it("position is right before the start line", function()
                -- line base1=10 => base0=9
                local position = GetPos.GetPosPosition:new({ line_base1 = 10, col_base1 = 1 })
            ...
            describe("position is on the start line", function()
                ...
                it("right after the start_col", function()
                    local position = GetPos.GetPosPosition:new({ line_base1 = 11, col_base1 = 7 })
                    assert.is_true(position:in_range(node))
                end)
            end)
            ...
            describe("position is on the end line", function()
                ...
                it("on the end_col (non-inclusive => FALSE)", function()
...
_describe("GetPosSelectionRange", function()
    it(":new(range) uses range object fields", function()
        ...
        assert.equal(instance.end_line_base1, 3)
        assert.equal(instance.end_col_base1, 4)
