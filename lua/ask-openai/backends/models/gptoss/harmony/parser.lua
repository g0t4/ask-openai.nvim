...
-- TODO! this is not even reviewed yet, nor used yet...
--   intended for manually parsing prompt output from gptoss only
--   for scenario where I need to build the raw prompt myself (i.e. to provide initial reasoning text to guide model)
