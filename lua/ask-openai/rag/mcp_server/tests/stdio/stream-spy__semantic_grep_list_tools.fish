...
set STREAM_SPY "$PYTHON_TOOLS_REPO/stream-spy"
...
begin
    ...
    | env PYTHONPATH="$STREAM_SPY" $_python3 -m stream_spy.__main__ -- fish -ic "mcp_server_semantic_grep --root-dir $PYTHON_TOOLS_REPO"
